...
public class SpongeFactoryFluidTypes {
    ...
    public static final RegistryObject<FluidType> POTASSIUM_HYDROXIDE_SOLUTION = REGISTER.register("potassium_hydroxide_solution", () -> new BaseFluidType().color(0xFF3B409E));
