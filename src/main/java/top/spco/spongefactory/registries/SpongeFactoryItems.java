 ...
 * @since 0.1.0
 */
public class SpongeFactoryItems {
    ...
    public static final ItemMapping<SimpleFoiledItem> HOLY_SHIT = item("Holy Shit", "上帝的屎", "holy_shit",
            () -> new SimpleFoiledItem((new Item.Properties()).tab(SpongeFactoryCreativeModTabs.MATERIAL.get()).rarity(Rarity.create("HOLY", ChatFormatting.GOLD))));
