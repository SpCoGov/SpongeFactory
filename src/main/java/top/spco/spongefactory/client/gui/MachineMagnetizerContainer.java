...
public class MachineMagnetizerContainer extends TileCoFHContainer {

    public final Reconfigurable4WayBlockEntity tile;

    public MachineMagnetizerContainer(int windowId, Level level, BlockPos pos, Inventory inventory, Player player) {
        super(SFContainerTypes.MAGNETIZER.get(), windowId, level, pos, inventory, player);
